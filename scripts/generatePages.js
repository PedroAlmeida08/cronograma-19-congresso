      ...
      let pageHTML = `
                        <div class="page">
                            <header class="flex justify-between items-center pb-4 border-b-2 border-palette-medium mb-6">
                                ...
                                <h2 class="text-3xl font-bold text-palette-darkest">${dayInfo.dayName} (${dayInfo.date})${etapaText}</h2>
                                <div class="w-16"></div>
                            </header>
                                ...
                                <table class="w-full text-left border-collapse">
                                    <thead>
                                        <tr class="table-header">
                                            <th class="p-2 text-base w-1/12">Horário</th>
                                            <th class="p-2 text-base w-6/12">Atividade</th>
                                            <th class="p-2 text-base w-5/12">Responsáveis</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                    `;
      ...
      pageActivities.forEach((item, index) => {
        ...
        pageHTML += `
                            <tr class="${rowClass}">
                                ...
                                <td class="p-2 text-base">${item.responsible}</td>
                            </tr>
                        `;
      });
